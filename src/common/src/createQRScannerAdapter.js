...
function clearBackground() {
  ...
  if (body.style) {
    ...
    if (body.parentNode && body.parentNode.style) {
      oldBackGround.pBackgroundColor = body.parentNode.style.backgroundColor;
      oldBackGround.pBackgroundImage = body.parentNode.style.backgroundImage;
...
function resumeBackground() {
  var body = document.body;
  if (body.style && oldBackGround.backgroundColor) {
    oldBackGround.backgroundColor = undefined;
    oldBackGround.backgroundImage = undefined;
    oldBackGround.pBackgroundColor = undefined;
    oldBackGround.pBackgroundImage = undefined;
...
return {
  ...
  destroy: function(callback) {
    cordova.exec(doneCallback(callback, false), null, 'QRScanner', 'destroy', []);
  },
  ...
  hide: function(callback) {
    cordova.exec(doneCallback(callback, false), null, 'QRScanner', 'hide', []);
  },
